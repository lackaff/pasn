...
<?php
		...
		echo "<h3>With which friends from work do you discuss personal matters? (Question 4 of 6)</h3>";
		
		$f = new CodonForm();
		$f->StartForm(array(
				'name' => 'addExternalFriendTo' . 'work',
				'url' => 'AJAXFunctions/addExternalFriendToBucket',
				'ajax' => true,
				'method' => 'post',
				'updatediv' => '#message'
		));
		$f->Hidden('bucket_name','work');
...
<hr />
<p>When you have added everyone you can remember, please <a href="<?=LINK_BASE?>/ExternalFriendManager/nameGenerator5" class="next">continue</a></p>
