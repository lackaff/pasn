...
<?php
		...
		echo "<h3>With which friends from organizations or clubs do you discuss personal matters? (Question 5 of 6)</h3>";
		
		$f = new CodonForm();
		$f->StartForm(array(
				'name' => 'addExternalFriendTo' . 'activity',
				'url' => 'AJAXFunctions/addExternalFriendToBucket',
				'ajax' => true,
				'method' => 'post',
				'updatediv' => '#message'
		));
		$f->Hidden('bucket_name','activity');
...
<hr />
<p>When you have added everyone you can remember, please <a href="<?=LINK_BASE?>/ExternalFriendManager/nameGenerator6" class="next">continue</a></p>
