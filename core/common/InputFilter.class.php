...
class InputFilter {
	...
	/** 
	  ...
	  */
	public function __construct($tagsArray = array(), $attrArray = array(), $tagsMethod = 1, $attrMethod = 1, $xssAuto = 1) {		
		...
		$this->tagBlacklist = Config::Get('TAG_BLACKLIST');
		$this->attrBlacklist = Config::Get('ATTR_BLACKLIST');
	}
